...
namespace Lab_2_repaso
{
    class Datos
    {
        ...
        public Datos(string nIT, string name, string direction, string licensePlate, string marca, int model, string color, double price, DateTime rentalDate, DateTime returnDate, double kilometersTraveled)
        {
            NIT1 = nIT;
            this.Name = name;
